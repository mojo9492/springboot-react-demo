...
import com.boberlabs.amigoscode1.student.Student;
import com.boberlabs.amigoscode1.student.StudentRepository;
...
public class StudentIT {
    ...
    void canRegisterNewStudent() throws Exception {
        ...
        String email = String.format("%s@boberlabs.com", StringUtils.trimAllWhitespace(name.trim().toLowerCase()));
